...
Public Class MainForm1
    ...
    Private Sub Update_Profit_Costing()
        ...
        TextBox1.Text = totalEcoCost.ToString("N2").TrimEnd("0"c).TrimEnd("."c)
        TextBox2.Text = totalEcoSale.ToString("N2").TrimEnd("0"c).TrimEnd("."c)
        TextBox3.Text = totalEcoProfit.ToString("N2").TrimEnd("0"c).TrimEnd("."c)
        TextBox4.Text = totalBusCost.ToString("N2").TrimEnd("0"c).TrimEnd("."c)
        TextBox5.Text = totalBusSale.ToString("N2").TrimEnd("0"c).TrimEnd("."c)
        TextBox6.Text = totalBusProfit.ToString("N2").TrimEnd("0"c).TrimEnd("."c)
        TextBox7.Text = grandTotalCost.ToString("N2").TrimEnd("0"c).TrimEnd("."c)
        TextBox8.Text = grandTotalSale.ToString("N2").TrimEnd("0"c).TrimEnd("."c)
        TextBox9.Text = grandTotalProfit.ToString("N2").TrimEnd("0"c).TrimEnd("."c)

        If totalEcoProfit < 0 Then
            TextBox3.ForeColor = Color.Red
        ElseIf totalEcoProfit = 0 Then
            TextBox3.ForeColor = Color.Black
        Else
            TextBox3.ForeColor = Color.Green
        End If

        If totalBusProfit < 0 Then
            TextBox6.ForeColor = Color.Red
        ElseIf totalBusProfit = 0 Then
        ...
        ElseIf grandTotalProfit = 0 Then
